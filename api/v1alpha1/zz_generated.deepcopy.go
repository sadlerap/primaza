...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceClassConstraints) DeepCopyInto(out *ServiceClassConstraints) {
	*out = *in
	if in.Environments != nil {
		in, out := &in.Environments, &out.Environments
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceClassConstraints.
func (in *ServiceClassConstraints) DeepCopy() *ServiceClassConstraints {
	if in == nil {
		return nil
	}
	out := new(ServiceClassConstraints)
	in.DeepCopyInto(out)
	return out
}
